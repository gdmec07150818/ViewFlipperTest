package cn.s07150818edu.viewflippertest;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ViewFlipper vflp_help;
    private int[] resId = {R.layout.page_help_one,R.layout.page_help_two,
            R.layout.page_help_three,R.layout.page_help_four,};

    private final static int MIN_MOVE = 180;   //最小距离
